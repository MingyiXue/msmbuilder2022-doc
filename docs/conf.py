...
version = msmbuilder.version.short_version
# The full version, including alpha/beta/rc tags.
release = msmbuilder.version.version
...
html_context = {
    'versions_json_url': 'http://msmbuilder.org/versions.json'
}
...
texinfo_documents = [
    ('index', 'MSMBuilder', 'MSMBuilder Documentation',
     'Stanford University', 'MSMBuilder',
     'Statistical models for Biomolecular Dynamics.', 'Scientific'),
]
